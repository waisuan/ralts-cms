...
export const mockMaintenanceRecords: Maintenance[] = [
  {
    ...
    action_taken: 'Completed routine preventive maintenance. Replaced air filters, checked fluid levels, and performed system diagnostics. All components functioning within normal parameters.',
  ...
  },
  {
    ...
    action_taken: 'Emergency repair due to hydraulic pump failure. Replaced faulty pump assembly and tested system pressure. Machine returned to full operational status.',
  ...
  },
  {
    ...
    action_taken: 'Corrective maintenance to address belt tension issues. Adjusted tension on drive belts and replaced worn components. System calibration completed.',
  ...
  },
  {
    ...
    action_taken: 'Monthly inspection and lubrication service. Checked all moving parts, applied lubricants as per schedule, and verified safety systems.',
  ...
  },
  {
    ...
    action_taken: 'Replaced worn-out conveyor belt and realigned transport mechanism. Performed load testing to ensure proper operation.',
  ...
  },
  {
    ...
    action_taken: 'Quarterly preventive maintenance cycle. Complete system overhaul including filter replacement, fluid changes, and comprehensive testing.',
  ...
  },
  {
    ...
    action_taken: 'Emergency shutdown investigation. Found and repaired electrical fault in control panel. Updated safety protocols and tested all emergency systems.',

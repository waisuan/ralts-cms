    ...
    <div className="flex justify-center mb-6">
      <div className="w-full max-w-2xl relative">
        <div className="flex items-center bg-white border border-gray-300 rounded-lg shadow-sm focus-within:ring-2 focus-within:ring-blue-500 focus-within:border-transparent">
          {/* Search Property Dropdown — compact icon on mobile, full label on desktop */}
          <div className="relative flex">
            <button
              type="button"
              onClick={() => setIsDropdownOpen(!isDropdownOpen)}
              className="flex items-center px-3 md:px-4 py-2 bg-gray-50 border-r border-gray-300 rounded-l-lg hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors"
              aria-label={`Search by ${currentProperty?.label}`}
            >
              <span className="text-sm font-medium text-gray-700 min-w-max hidden md:inline">
                {currentProperty?.label}
              </span>
              <svg
                className="h-4 w-4 text-gray-500 md:hidden"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
              ...
              <svg
                className="ml-1 md:ml-2 h-4 w-4 text-gray-500"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >

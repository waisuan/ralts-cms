          ...
          <form onSubmit={handleSubmit} className="px-6 py-6">
            ...
            <div className="mb-4">
              ...
              <input
                ...
                className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent placeholder-gray-400 text-gray-900 ${
